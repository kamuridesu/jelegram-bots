...
public interface ITelegramBot {
    ...
    /**
     * Starts long polling to fetch updates from the api and handle those updates. By default it uses {@link IUpdateHandler}.
     * @param interval Integer to sleep the thread while waits for updates to avoid spamming on the Telegram API.
     ...
     * @throws InterruptedException
     */
    void startPolling(Integer interval, @Nullable Consumer<Update> callback) throws InterruptedException;
